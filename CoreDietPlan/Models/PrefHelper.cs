...
namespace CoreDietPlan.Models
{
    public static class PrefHelper
    {
        public static HtmlString FoodDiv(Meal items)
        {
            ...
            sb.Append($"                                                    <span  id={trim} style=\"visibility:visible;\" class=\"pull-right clickable\" data-effect=\"fadeOut\"><i class=\"fa fa-times\"></i></span>");
            ...
            sb.Append($"                                                        <p class=\"text-center\">Serving:<span>{items.serving}</span></p>");
